...
try:
	...
	print R + '_ZYAN_'.center(44)

	print ('ZYAN').center(44)
	print ' '
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     GH057-4-4NG3L'ZYAN'
    Name       ZYAN'Open Source Information Facebook'
 ✗ZYAN ZYN✗
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'ZYAN' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'ZYAN' + W +'/' + R +'Bot ' + W + '>> ')
